...
public class VarByteSingleValueReaderWriteTest {
  ...
  public void test()
    ...
    for (int i = 0; i < NUM_STRINGS; i++) {
      ...
      maxStringLengthInBytes = Math.max(maxStringLengthInBytes, expected[i].getBytes().length);
    }
    ...
    ChunkUncompressor uncompressor = ChunkCompressorFactory.getUncompressor("snappy");
